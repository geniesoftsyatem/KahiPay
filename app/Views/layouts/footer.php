<footer class="text-center text-lg-start bg-dark text-white">
        ...
        <div class="container text-center text-md-start mt-5">
            <div class="row mt-3">
                ...
                <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
                    ...
                    <p><a href="#!" class="text-reset">Rent Products</a></p>
                    <p><a href="#!" class="text-reset">Sale Products</a></p>
    ...
    <!-- Copyright -->
    <div class="text-center p-4 bg-secondary text-white">© 2024 Geniesoft System, All Rights Reserved</div>
</footer>